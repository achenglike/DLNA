package com.imooc.dlna.mediaserver;
...
public class SimpleWebServer extends NanoHTTPD {
    ...
    private void innerCallStop() {
        this.stop();
    }
    
   /* 
    * 注释掉的无用代码，未删除是方便阅读SimpleWebServer的使用
    * */
    /**
...
*/
    ...
    public Response serve(IHTTPSession session) {
         ...
         * 设置定时器
         */
        handler.removeCallbacks(runnable);  //移除原有定时器
        handler.postDelayed(runnable, 1000 * 60 * 15);     //重新设置定时器 15分钟停止
